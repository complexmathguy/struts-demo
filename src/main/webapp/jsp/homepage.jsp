...
<script type="text/javascript">
	...
	function populateTree()
	{
		var content = '<ul>';
			...
			content = content + '<li id="Player"><font style="font-size:0.8em;">Player</font></li>';
			content = content + '<li id="League"><font style="font-size:0.8em;">League</font></li>';
			content = content + '<li id="Tournament"><font style="font-size:0.8em;">Tournament</font></li>';
			content = content + '<li id="Matchup"><font style="font-size:0.8em;">Matchup</font></li>';
			content = content + '<li id="Game"><font style="font-size:0.8em;">Game</font></li>';
